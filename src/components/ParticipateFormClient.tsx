...
export default function ParticipateFormClient({ presale }: ParticipateFormClientProps) {
      ...
      <div className="ml-56 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Contribute HL tokens to receive {presale.tokenSymbol}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="font-semibold ml-2">{formatAmount(presale.softcap)} HL</span>
              </div>
              <div>
                <span className="text-gray-600">Hard Cap:</span>
                <span className="font-semibold ml-2">{formatAmount(presale.hardcap)} HL</span>
              </div>
              <div>
